...
function data_loader(obj) {
    ...
    document.getElementById('status').innerHTML = "GNSS system is " + obj.val().status
    ...
    if(obj.val().sw_1 == 0){
        document.getElementById('sw_1_status').innerHTML = "OFF"
    } else{
        document.getElementById('sw_1_status').innerHTML = "ON"
    }
    if(obj.val().sw_2 == 0){
        document.getElementById('sw_2_status').innerHTML = "OFF"
    } else{
        document.getElementById('sw_2_status').innerHTML = "ON"
    }
    if(obj.val().sw_3 == 0){
        document.getElementById('sw_3_status').innerHTML = "OFF"
    } else{
        document.getElementById('sw_3_status').innerHTML = "ON"
    }
    if(obj.val().control == 0){
        document.getElementById('iot').innerHTML = "Deactivated"
    } else{
        document.getElementById('iot').innerHTML = "Activated"
    }
...
function refreshMarker(obj) {
    ...
    document.getElementById('speed').innerHTML = "Movement Speed is : " + obj.val().speed
    document.getElementById('lastRun').innerHTML = "Last RUN : " + obj.val().lastRun
    document.getElementById('iot').innerHTML = obj.val().control
    if(obj.val().sw_1 == 0){
        document.getElementById('sw_1_status').innerHTML = "OFF"
    } else{
        document.getElementById('sw_1_status').innerHTML = "ON"
